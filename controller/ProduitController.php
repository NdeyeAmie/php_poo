        ...
        switch ($action) {
            case 'connexion':
                ...
                if ($bool == 1) {
                    ...
                    header('Location:/gestion_stock_xarala/index.php?view=listeproduit');
    
                }else {
                    $sms = "Nom d'utilisateur ou mot de passe incorrect";
                    header('Location:/gestion_stock_xarala/index.php?view=login&sms='.$sms);
                }
            ...
            case 'ajoutproduit':
                if (isset($_POST['ajouter'])) {
                    ...
                    if($res){
                        ...
                        header('Location:/gestion_stock_xarala/index.php?view=listeproduit&smssuccess='.$smssuccess);
                    }else {
                        $smsdanger = "Enregistrement non effectué";
                        header('Location:/g_stock_xarala/index.php?view=listeproduit&smsdanger='.$smsdanger);
                    }
                }
                break;
            ...
            case 'supprimer':
                if (isset($_GET['id'])) {
                    ...
                    if($res){
                        ...
                        header('Location:/gestion_stock_xarala/index.php?view=listeproduit&smsdanger='.$smsdanger);
                    }
            ...
            case 'ajoutentree':
                if (isset($_POST['ajouter'])) {
                    ...
                    if ($res) {
                        header('Location:/gestion_stock_xarala/index.php?view=entreeproduit');
                    }else {
                        echo 'no';
                    }
            ...
            case 'ajoutsortie':
                if (isset($_POST['ajouter'])) {
                    ...
                    if ($res) {
                        ...
                        header('Location:/gestion_stock_xarala/index.php?view=sortieproduit&smssuccess='.$smssuccess);
                    }   
                }
                break;
            ...
            case 'supprimersortie':
                if (isset($_GET['id'])) {
                    ...
                    header('Location:/gestion_stock_xarala/index.php?view=sortieproduit');
                }
                break;
                ...
                if (isset($_POST['inscription'])) {
                     ...
                     $res = $this->userModel->userNameExist($username);
                         ...
                         if ($res == 0) {
                             ...
                             header('Location:/gestion_stock_xarala/index.php?view=login&smssuccess='.$smssuccess);
                         }
                else {
                            // echo 'no1';
                            $sms = "Votre nom d'utilisateur existe déja dans la BDD";
                            echo $usernameExist;
                            header('Location:/gestion_stock_xarala/index.php?view=inscription&sms='.$sms);
                        }   
                    }else {
                        echo 'no12';
