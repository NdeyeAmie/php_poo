    ...
    <div class="row">
                ...
                <tbody>
                    <?php 
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/gestion_stock_xarala/index.php?action=supprimersortie&id=<?= $le['idsortie'] ?>"  class="btn btn-danger"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
        ...
        <div class="col-md-5">
            <div class="card border-dark">
                ...
                <form action="/gestion_stock_xarala/index.php?action=ajoutsortie" method="post">
                <div class="card-body">
