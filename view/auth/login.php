        ...
        <div class="row mt-5">
            <div class="col-md-6 offset-3 mt-5">
                <div class="card border-primary">
                    ...
                    <form action="/gestion_stock_xarala/index.php?action=connexion" method="post">
                    <div class="card-body">
                    ...
                    <div class="card-footer text-center">
                        <p> Vous n'avez pas de compte <a href="/gestion_stock_xarala/view/auth/inscription.php">Inscription</a></p>
                    </div>
                </div>
            </div>
        </div>
