        ...
        <div class="row">
            <div class="col-md-6 offset-3 mt-5">
                <div class="card border-primary">
                    ...
                    <form action="/gestion_stock_xarala/index.php?action=inscription" method="post">
                    <div class="card-body">
                    <?php 
                        if (isset($_GET['sms'])) {
                    ...
                    <div class="card-footer text-center">
                        <p> Vous avez déja un compte <a href="/gestion_stock_xarala/index.php">Connexion</a></p>
                </div>
                </div>
